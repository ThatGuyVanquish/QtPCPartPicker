...
private:
    ...
    QList<storage*> findHDDs(int budget, int slotLimit, QList<storage*> list, int index);
...
public:
    ...
    motherboard *findMobo(int budget, QString manu, QString socket = nullptr, QString purpose = "");
